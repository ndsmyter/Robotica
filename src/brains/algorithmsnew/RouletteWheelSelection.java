...
public class RouletteWheelSelection {
	...
	private Particle nextRandomParticle(List<Particle> particles, double sumWeight) {
	...
	public ArrayList<Particle> nextRandomParticles(List<Particle> particles, int n) {
		double sumWeight = calculateSumWeight(particles);
